...
void getPos()
{
  s_x += 3*9.80665 * sin(angle_x ) * (time_period/1000000.0) * (1+time_period/2000000.0);
  s_y += 3*9.80665 * sin(angle_y ) * (time_period/1000000.0) * (1+time_period/2000000.0);
  if (abs(s_x) + 3.5 < 7)
  {
    pos_x =s_x + 3.6;
  }
